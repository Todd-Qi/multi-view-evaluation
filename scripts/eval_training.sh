...
nohup ../build/ETH3DMultiViewEvaluation \
    --reconstruction_ply_path /mnt/H/xxx/UCSNet/ETH3D/point_clouds/${scene}.ply \
    --ground_truth_mlp_path /mnt/G1/yyy/MVS_GT/ETH3D/${scene}/dslr_scan_eval/scan_alignment.mlp \
